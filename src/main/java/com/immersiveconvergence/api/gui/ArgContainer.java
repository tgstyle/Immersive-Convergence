...
@SuppressWarnings({"unused", "RedundantSuppression"}) public class ArgContainer<T, C extends AbstractContainerMenu> {
    ...
    public static <C extends AbstractContainerMenu> RegistryObject<MenuType<C>> registerType(DeferredRegister<MenuType<?>> register, String name, IClientContainerConstructor<C> client) {
