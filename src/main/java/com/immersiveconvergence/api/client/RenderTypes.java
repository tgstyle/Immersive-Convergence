...
@SuppressWarnings({"unused", "RedundantSuppression"}) public class RenderTypes extends RenderStateShard {
    ...
    static {
        ...
        TRANSLUCENT_POSITION_COLOR = createDefault("immersiveconvergence:translucent_pos_color", DefaultVertexFormat.POSITION_COLOR, translucentNoTextureState);
        ...
        FLUID_SOLID_NO_CULL = RenderType.create("immersiveconvergence:fluid_solid_no_cull", DefaultVertexFormat.BLOCK, VertexFormat.Mode.QUADS, 256, true, false, fluidSolidNoCullState);
    }
