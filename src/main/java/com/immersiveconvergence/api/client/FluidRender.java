...
@SuppressWarnings({"unused", "RedundantSuppression"}) public class FluidRender {
    ...
    @SuppressWarnings("resource") public static void drawRepeatedFluidSprite(VertexConsumer builder, PoseStack transform, FluidStack fluid, float x, float y, float w, float h) {
