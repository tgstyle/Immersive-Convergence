...
public final class CyclicListWrapper<T> {
    private final List<T> wrapped;

    public CyclicListWrapper(List<T> wrapped) { this.wrapped = wrapped; }

    public T get(int i) { return this.wrapped.get(this.toIndex(i)); }
