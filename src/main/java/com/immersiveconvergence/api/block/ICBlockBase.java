...
public class ICBlockBase<E extends Enum<E> & ICBlockBase.IBlockEnum> extends Block implements IIEMetaBlock {
    ...
    public ICBlockBase(BlockContext context, String name, Material material, PropertyEnum<E> mainProperty, Class<? extends ItemBlock> itemBlock, Object... additionalProperties) {
        ...
        this.setCreativeTab(context.creativeTab);
        this.adjustSound();
        context.registeredBlocks.add(this);
        try {
            context.registeredItems.add(itemBlock.getConstructor(Block.class).newInstance(this));
        } catch (Exception e) {
            context.logger.error("ICBlockBase constructor for {} failed to register itemBlock", name, e);
        }
        lightOpacity = 255;
    }
    ...
    public ICBlockBase<E> setMetaExplosionResistance(int meta, float resistance) {
    ...
    public String createRegistryName() { return context.modid + ":" + name; }
