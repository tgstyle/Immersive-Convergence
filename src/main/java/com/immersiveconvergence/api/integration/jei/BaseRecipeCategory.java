...
@SuppressWarnings({"unused", "RedundantSuppression"}) public abstract class BaseRecipeCategory<T> implements IRecipeCategory<T> {
    ...
    public BaseRecipeCategory(IGuiHelper guiHelper, RecipeType<T> type, String localKey) {
    ...
    @Override @Nonnull public Component getTitle() { return this.title; }

    @Override @Nonnull public final RecipeType<T> getRecipeType() { return type; }
