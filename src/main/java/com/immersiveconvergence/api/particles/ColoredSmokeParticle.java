...
public class ColoredSmokeParticle extends TextureSheetParticle {
    ...
    public ColoredSmokeParticle(ClientLevel level, double x, double y, double z, double velX, double velY, double velZ, Vector3f color, boolean collideHorizontal, boolean collideVertical, SpriteSet sprites) {
        super(level, x, y, z);
        this.rCol = color.x();
        this.gCol = color.y();
        this.bCol = color.z();
        ...
        if (ParticleSettings.particleCollide.getAsBoolean()) { this.collideHorizontal = true; this.collideVertical = true; }
    ...
    @Override public void tick() {
        ...
        if (this.age++ >= this.lifetime) { this.remove(); }
            ...
            double scale = ParticleSettings.coloredSmokeHeight.getAsDouble() / 3.0D;
