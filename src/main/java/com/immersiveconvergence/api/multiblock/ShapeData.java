...
public final class ShapeData extends GenericShape {
    ...
    public static ShapeData load(String modid, String id) {
        MultiblockJSONSchema data = MultiblockUtils.Load(modid, "multiblocks/" + id + ".json");
        if (data == null) { ICLogger.error("Missing multiblock JSON: " + id); return new ShapeData(0, 0, 0, null, BlockPos.ORIGIN, new ArrayList<>()); }
