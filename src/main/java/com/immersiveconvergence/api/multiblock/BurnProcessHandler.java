...
@SuppressWarnings({"unused", "RedundantSuppression"}) public class BurnProcessHandler<R extends IESerializableRecipe> {
    private double process = 0;
    private double processMax = 0;
    private double burnTime = 0;
    private double lastBurnTime = 0;
    public final FurnaceStateView stateView = new FurnaceStateView();
    ...
    public BurnProcessHandler(int fuelSlot, List<InputSlot<R>> inputs, List<OutputSlot<R>> outputs, ToIntFunction<R> getProcessingTime, Runnable setChanged) { this.fuelSlot = fuelSlot; this.inputs = inputs; this.outputs = outputs; this.getProcessingTime = getProcessingTime; this.setChanged = setChanged; }
    ...
    public class FurnaceStateView implements ContainerData {
