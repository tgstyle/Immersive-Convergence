...
@SuppressWarnings({"unused", "RedundantSuppression"}) public class ConstrainedItemHandler implements IItemHandlerModifiable, Iterable<ItemStack> {
    ...
    public ConstrainedItemHandler(List<IOConstraint> slotConstraints, Runnable onChanged) {
    ...
    public record IOConstraint(boolean allowExtract, Predicate<ItemStack> allowInsert) {
        ...
        public static final IOConstraint FLUID_INPUT = IOConstraint.input(ICFluidUtils::isFluidRelatedItemStack);
