...
@SuppressWarnings({"unused", "RedundantSuppression"}) public class LayeredComparator<CTX> {
    ...
    public LayeredComparator(double maxValue, int numLayers, ObjIntConsumer<CTX> updateMaster, LayerUpdater<CTX> updateLayer) {
