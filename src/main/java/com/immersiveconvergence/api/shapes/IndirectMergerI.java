...
public class IndirectMergerI implements IIndexMerger {
    ...
    public IndirectMergerI(DoubleList pLower, DoubleList pUpper, boolean pExcludeUpper, boolean pExcludeLower) {
